...
parser = argparse.ArgumentParser(description='This script registers Embedding models to SAS Model Manager')
...
project_attributes['project_name'] = 'Embedding Model Project'
project_attributes['project_model_function'] = 'Embedding'
project_attributes['project_description'] = 'This project stores all Embedding models that are available to be used in use cases. It is possible to grant access to these models on a per model basis. Along side the availability this also documents on how to deploy/call the models.'
project_attributes['project_tags'] = ['Embedding-Models', 'SCR-Definitions', 'Python']
