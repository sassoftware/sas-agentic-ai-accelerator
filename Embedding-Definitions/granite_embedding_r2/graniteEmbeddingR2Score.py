# GENERATED by mdb 0.1.0 from definition.yaml - edit definition.yaml and run 'mdb generate granite_embedding_r2' instead of editing this file.
import time
import json
import logging
import sys
...
checkpoint = './granite_embedding_r2'
