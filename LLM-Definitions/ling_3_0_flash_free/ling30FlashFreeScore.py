# GENERATED by mdb 0.1.0 from definition.yaml - edit definition.yaml and run 'mdb generate ling_3_0_flash_free' instead of editing this file.
import time
import json
import logging
import sys
...
modelVersion = 'inclusionai/ling-3.0-flash:free'
