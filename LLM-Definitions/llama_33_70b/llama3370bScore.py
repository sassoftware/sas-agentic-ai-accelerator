# GENERATED by mdb 0.1.0 from definition.yaml - edit definition.yaml and run 'mdb generate llama_33_70b' instead of editing this file.
import time
import json
import logging
import sys
...
modelVersion = 'meta-llama/llama-3.3-70b-instruct'
