# GENERATED by mdb 0.1.0 from definition.yaml - edit definition.yaml and run 'mdb generate google_gemma_4_31b_free' instead of editing this file.
import time
import json
import logging
import sys
...
modelVersion = 'google/gemma-4-31b-it:free'
