# GENERATED by mdb 0.1.0 from definition.yaml - edit definition.yaml and run 'mdb generate poolside_laguna_s_2_1_free' instead of editing this file.
import time
import json
import logging
import sys
...
modelVersion = 'poolside/laguna-s-2.1:free'
