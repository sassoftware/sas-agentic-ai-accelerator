# GENERATED by mdb 0.1.0 from definition.yaml - edit definition.yaml and run 'mdb generate gemini_flash_lite_25' instead of editing this file.
import time
import json
import logging
import sys
...
modelVersion = 'gemini_flash_lite_25'
...
def scoreModel(userPrompt, systemPrompt, options):
    ...
    response = "".join(
        part["text"] for part in responseJson["candidates"][0]["content"]["parts"] if "text" in part
    )
