# GENERATED by mdb 0.1.0 from definition.yaml - edit definition.yaml and run 'mdb generate gemini_flash_15_001' instead of editing this file.
import time
import json
import logging
import sys
...
modelVersion = 'gemini_flash_15_001'
