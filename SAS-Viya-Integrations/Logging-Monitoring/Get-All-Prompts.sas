            ...
            * One row per run header (ordinal_root), with the three metrics;
            ...
            data work._gap_all_experiments_temp(drop=systemPromptTEMP userPromptTEMP vcTEMP illcTEMP ovcTEMP jmTEMP jcTEMP jmodeTEMP jpanelTEMP jagrTEMP ordinal_root);
                ...
                * Set the prompts and carry the run-level metrics from the header
                ...
                retain systemPromptTEMP userPromptTEMP vcTEMP illcTEMP ovcTEMP jmTEMP jcTEMP jmodeTEMP jpanelTEMP jagrTEMP;
            run;
