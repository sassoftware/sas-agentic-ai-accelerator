...
Except for the contents of the `/static` folder, this project is licensed under the [Apache 2.0 License](./LICENSE).
...
This project also makes use of the [SAS Portal Framework for SAS Viya](https://github.com/sassoftware/sas-portal-framework-for-sas-viya).
